...
HELP_TEXTS: dict[str, str] = {
    ...
    "GROUP_ALLOWLIST": "允许自动回复的群号。多个群号用半角逗号分隔，例如 975426289,123456789；这里填群号，不是群名。智能跟随和群聊都回只对这里的群生效。当前没有单独的主动消息白名单。",
...
群聊白名单：
1. 填群号，不是群名；例如 975426289。
2. 多个群号用半角逗号分隔，例如 975426289,123456789。
